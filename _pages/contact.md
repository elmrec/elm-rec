...
<section class="page-cta-panel" aria-label="Next step">
  <div>
    ...
    <h2>If you are not sure where to start, join WhatsApp first.</h2>
    <p>That is the easiest way to see the rhythm of the group and decide whether you want to attend an event, volunteer, or simply stay informed.</p>
  </div>
  <div class="page-cta-panel__actions">
    ...
    <a class="btn btn--primary" href="mailto:friendselmroadrec@gmail.com">Send Email</a>
  </div>
</section>
